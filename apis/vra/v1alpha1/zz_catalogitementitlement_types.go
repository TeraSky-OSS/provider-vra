...
// CatalogItemEntitlement is the Schema for the CatalogItemEntitlements API. A resource that can be used to create a VMware Aria Automation catalog item entitlement.
