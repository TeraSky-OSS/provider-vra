...
type ImageMappingConstraintsInitParameters struct {
...
type ImageMappingConstraintsObservation struct {
...
type ImageMappingConstraintsParameters struct {
...
type ImageMappingInitParameters struct {
	...
	Constraints []ImageMappingConstraintsInitParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ImageMappingObservation struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Constraints []ImageMappingConstraintsObservation `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ImageMappingParameters struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	// +kubebuilder:validation:Optional
	Constraints []ImageMappingConstraintsParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ImageProfileInitParameters struct {
...
type ImageProfileObservation struct {
...
type ImageProfileParameters struct {
...
// ImageProfileSpec defines the desired state of ImageProfile
type ImageProfileSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ImageProfileParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ImageProfileInitParameters `json:"initProvider,omitempty"`
}

// ImageProfileStatus defines the observed state of ImageProfile.
type ImageProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ImageProfileObservation `json:"atProvider,omitempty"`
}
...
// ImageProfile is the Schema for the ImageProfiles API. Provides a data lookup for vra_image_profile.
...
type ImageProfile struct {
	...
	Spec   ImageProfileSpec   `json:"spec"`
	Status ImageProfileStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ImageProfileList contains a list of ImageProfiles
...
var (
	ImageProfile_Kind             = "ImageProfile"
	ImageProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ImageProfile_Kind}.String()
	ImageProfile_KindAPIVersion   = ImageProfile_Kind + "." + CRDGroupVersion.String()
	ImageProfile_GroupVersionKind = CRDGroupVersion.WithKind(ImageProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&ImageProfile{}, &ImageProfileList{})
}
