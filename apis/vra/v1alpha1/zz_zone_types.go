...
type ZoneInitParameters struct {
	...
	Tags []ZoneTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type ZoneLinksInitParameters struct {
}

type ZoneLinksObservation struct {
...
type ZoneLinksParameters struct {
}
...
type ZoneObservation struct {
	...
	Links []ZoneLinksObservation `json:"links,omitempty" tf:"links,omitempty"`
	...
	// A set of tag keys and optional values that were set on this resource:
	Tags []ZoneTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type ZoneParameters struct {
	...
	// A set of tag keys and optional values that were set on this resource:
	// +kubebuilder:validation:Optional
	Tags []ZoneTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type ZoneTagsInitParameters struct {
...
type ZoneTagsObservation struct {
...
type ZoneTagsParameters struct {
...
// Zone is the Schema for the Zones API. Provides a vra_zone resource.
