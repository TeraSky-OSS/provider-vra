...
type MachineConstraintsInitParameters struct {
...
type MachineConstraintsObservation struct {
...
type MachineConstraintsParameters struct {
...
type MachineInitParameters struct {
	...
	Constraints []MachineConstraintsInitParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	Nics []MachineNicsInitParameters `json:"nics,omitempty" tf:"nics,omitempty"`
	...
	Tags []MachineTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type MachineLinksInitParameters struct {
}

type MachineLinksObservation struct {
...
type MachineLinksParameters struct {
}

type MachineNicsInitParameters struct {
...
type MachineNicsObservation struct {
...
type MachineNicsParameters struct {
...
type MachineObservation struct {
	...
	// Constraints used to drive placement policies for the virtual machine produced from the specification. Constraint expressions are matched against tags on existing placement targets. Example: [{"mandatory" : "true", "expression": "environment":"prod"}, {"mandatory" : "false", "expression": "pci"}]
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Constraints []MachineConstraintsObservation `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	Links []MachineLinksObservation `json:"links,omitempty" tf:"links,omitempty"`

	// Human-friendly block-device name used as an identifier in APIs that support this option.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// Set of network interface controller specifications for this machine. If not specified, then a default network connection will be created.
	Nics []MachineNicsObservation `json:"nics,omitempty" tf:"nics,omitempty"`
	...
	// Set of tag keys and optional values that should be set on any resource that is produced from this specification.Example: [ { "key" : "ownedBy", "value": "Rainpole" } ]. It is nested argument with the following properties.
	Tags []MachineTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type MachineParameters struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	// +kubebuilder:validation:Optional
	Constraints []MachineConstraintsParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	// Set of network interface controller specifications for this machine. If not specified, then a default network connection will be created.
	// +kubebuilder:validation:Optional
	Nics []MachineNicsParameters `json:"nics,omitempty" tf:"nics,omitempty"`
	...
	// Set of tag keys and optional values that should be set on any resource that is produced from this specification.Example: [ { "key" : "ownedBy", "value": "Rainpole" } ]. It is nested argument with the following properties.
	// +kubebuilder:validation:Optional
	Tags []MachineTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type MachineTagsInitParameters struct {
...
type MachineTagsObservation struct {
...
type MachineTagsParameters struct {
