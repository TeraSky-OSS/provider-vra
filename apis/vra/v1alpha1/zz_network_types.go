...
type NetworkConstraintsInitParameters struct {
...
type NetworkConstraintsObservation struct {
...
type NetworkConstraintsParameters struct {
...
type NetworkInitParameters struct {
	...
	Constraints []NetworkConstraintsInitParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	Tags []NetworkTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type NetworkLinksInitParameters struct {
}

type NetworkLinksObservation struct {
...
type NetworkLinksParameters struct {
}
...
type NetworkObservation struct {
	...
	// List of storage, network and extensibility constraints to be applied when provisioning through this project.
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Constraints []NetworkConstraintsObservation `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	Links []NetworkLinksObservation `json:"links,omitempty" tf:"links,omitempty"`
	...
	// A set of tag keys and optional values that were set on this resource. Example: [ { "key" : "ownedBy", "value": "Rainpole" } ]
	Tags []NetworkTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type NetworkParameters struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	// +kubebuilder:validation:Optional
	Constraints []NetworkConstraintsParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	// A set of tag keys and optional values that were set on this resource. Example: [ { "key" : "ownedBy", "value": "Rainpole" } ]
	// +kubebuilder:validation:Optional
	Tags []NetworkTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}
...
// Network is the Schema for the Networks API. Provides a vra_network resource.
