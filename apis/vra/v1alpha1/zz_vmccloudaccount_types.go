...
type VMCCloudAccountInitParameters struct {
	...
	Tags []VMCCloudAccountTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type VMCCloudAccountLinksInitParameters struct {
}

type VMCCloudAccountLinksObservation struct {
...
type VMCCloudAccountLinksParameters struct {
}

type VMCCloudAccountObservation struct {
	...
	Links []VMCCloudAccountLinksObservation `json:"links,omitempty" tf:"links,omitempty"`
	...
	// Set of tag keys and values to apply to the cloud account. Example: [ { "key" : "vmware", "value": "provider" } ]
	Tags []VMCCloudAccountTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type VMCCloudAccountParameters struct {
	...
	// Set of tag keys and values to apply to the cloud account. Example: [ { "key" : "vmware", "value": "provider" } ]
	// +kubebuilder:validation:Optional
	Tags []VMCCloudAccountTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type VMCCloudAccountTagsInitParameters struct {
	Key *string `json:"key,omitempty" tf:"key,omitempty"`

	Value *string `json:"value,omitempty" tf:"value,omitempty"`
}

type VMCCloudAccountTagsObservation struct {
	Key *string `json:"key,omitempty" tf:"key,omitempty"`

	Value *string `json:"value,omitempty" tf:"value,omitempty"`
}

type VMCCloudAccountTagsParameters struct {
...
// VMCCloudAccountSpec defines the desired state of VMCCloudAccount
type VMCCloudAccountSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VMCCloudAccountParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VMCCloudAccountInitParameters `json:"initProvider,omitempty"`
}

// VMCCloudAccountStatus defines the observed state of VMCCloudAccount.
type VMCCloudAccountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VMCCloudAccountObservation `json:"atProvider,omitempty"`
}
...
// VMCCloudAccount is the Schema for the VMCCloudAccounts API. Creates a vra_cloud_account_vmc resource.
...
type VMCCloudAccount struct {
	...
	Spec   VMCCloudAccountSpec   `json:"spec"`
	Status VMCCloudAccountStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VMCCloudAccountList contains a list of VMCCloudAccounts
type VMCCloudAccountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VMCCloudAccount `json:"items"`
}

// Repository type metadata.
var (
	VMCCloudAccount_Kind             = "VMCCloudAccount"
	VMCCloudAccount_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VMCCloudAccount_Kind}.String()
	VMCCloudAccount_KindAPIVersion   = VMCCloudAccount_Kind + "." + CRDGroupVersion.String()
	VMCCloudAccount_GroupVersionKind = CRDGroupVersion.WithKind(VMCCloudAccount_Kind)
)

func init() {
	SchemeBuilder.Register(&VMCCloudAccount{}, &VMCCloudAccountList{})
}
