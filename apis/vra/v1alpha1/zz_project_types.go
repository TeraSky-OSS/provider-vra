...
type ConstraintsNetworkInitParameters struct {
...
type ConstraintsNetworkObservation struct {
...
type ConstraintsNetworkParameters struct {
...
type ProjectConstraintsInitParameters struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Network []ConstraintsNetworkInitParameters `json:"network,omitempty" tf:"network,omitempty"`

	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Storage []StorageInitParameters `json:"storage,omitempty" tf:"storage,omitempty"`
}

type ProjectConstraintsObservation struct {

	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Extensibility []ExtensibilityObservation `json:"extensibility,omitempty" tf:"extensibility,omitempty"`

	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Network []ConstraintsNetworkObservation `json:"network,omitempty" tf:"network,omitempty"`

	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	Storage []StorageObservation `json:"storage,omitempty" tf:"storage,omitempty"`
}

type ProjectConstraintsParameters struct {
	...
	// Constraints that are used to drive placement policies for entities such as image, network, storage, etc. Constraint expressions are matched against tags on existing placement targets.
	// +kubebuilder:validation:Optional
	Network []ConstraintsNetworkParameters `json:"network,omitempty" tf:"network,omitempty"`
...
type ProjectInitParameters_2 struct {
	...
	Constraints []ProjectConstraintsInitParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ProjectObservation_2 struct {
	...
	// A list of storage, network, and extensibility constraints to be applied when provisioning through this project.
	// List of storage, network and extensibility constraints to be applied when provisioning through this project.
	Constraints []ProjectConstraintsObservation `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ProjectParameters_2 struct {
	...
	// List of storage, network and extensibility constraints to be applied when provisioning through this project.
	// +kubebuilder:validation:Optional
	Constraints []ProjectConstraintsParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
...
type ProjectSpec struct {
	...
	ForProvider     ProjectParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ProjectInitParameters_2 `json:"initProvider,omitempty"`
}

// ProjectStatus defines the observed state of Project.
type ProjectStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ProjectObservation_2 `json:"atProvider,omitempty"`
}
...
// Project is the Schema for the Projects API. Provides a VMware Aria Automation vra_project resource.
