...
PROJECT_REPO ?= github.com/terasky/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/vmware/terraform-provider-vra/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vra_$(TERRAFORM_PROVIDER_VERSION)
