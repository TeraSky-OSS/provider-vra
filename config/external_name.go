...
var ExternalNameConfigs = map[string]config.ExternalName{
    ...
    "vra_catalog_item_vm_image" : config.IdentifierFromProvider,
    "vra_catalog_item_vro_workflow" : config.IdentifierFromProvider,
    ...
    "vra_cloud_account_nsxv" : config.IdentifierFromProvider,
    ...
    "vra_policy_approval" : config.IdentifierFromProvider,
    "vra_policy_day2_action" : config.IdentifierFromProvider,
    "vra_policy_iaas_resource" : config.IdentifierFromProvider,
    "vra_policy_lease" : config.IdentifierFromProvider,
